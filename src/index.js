...
/*================Initialise the checkers=================================*/

// red checker
for (var i = 1; i <= 4; i++) {
  w_checker[i] = new checker(red_checker_class[i], "red", 2 * i - 1);
...
for (var i = 5; i <= 8; i++) {
  w_checker[i] = new checker(red_checker_class[i], "red", 2 * i);
  w_checker[i].setCoord(0, 0);
...
function showMoves(piece) {
  ...
  selectedPiece = piece;
  var i, j; // track the white checker
  for (j = 1; j <= 12; j++) {
  ...
  if (!match) {
    return 0; // handle no match case, make the red moves
  }

  /*===set the moves based on the checker===*/
  ...
  attackMoves(the_checker[i]); // checking if the checker can attack

  /*========if cannot attack make the checker possible move======*/
...
function makeMove(index) {
  ...
  if (the_checker[1].color == "red") {
    var cpy_downRight = upRight;
    var cpy_downLeft = upLeft;
    var cpy_upLeft = downLeft;
    var cpy_upRight = downRight;
  } else {
...
/*===========move the checker and change the coordinates======*/
...
function changeTurns(ckc) {
  if (ckc.color == "red") the_checker = b_checker;
...
function declareWinner() {
  ...
  0;
  if (the_checker[1].color == "red") score.innerHTML == "Black wins";
